...
if (isset($_POST['name'])) {
    ...
    $sql = "UPDATE student_information SET name = '$name', email = '$email', salary = $fees WHERE id = $id";
    mysqli_query($con, $sql);

    header('location: show_table.php?id='.$id);
}
    		...
    		<div class="col-md-8">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="fees" value="<?php echo $employee['fees']?>"></td>
                    </tr>
                    <tr>
                        <th></th>
